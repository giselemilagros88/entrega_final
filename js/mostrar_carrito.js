document.addEventListener("DOMContentLoaded", () => {
    ...
    //El método reduce es una función de los arrays en JavaScript que se utiliza para iterar sobre los elementos de un array y reducirlos a un único valor (como un número, un objeto, una cadena, etc.).
